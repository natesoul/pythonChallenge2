...
def add_to_dict(dic, word, definition=1):
    if type(dic) != dict:
...
def get_from_dict(dic, word=1, definition=1):
    if type(dic) != dict:
        print("You need to send a dictionary. You sent: <class 'str'>")
    elif word == 1:
...
def update_word(dic, word, definition=1):
    if type(dic) != dict:
        print("You need to send a dictionary. You sent: <class 'str'>")
    elif definition == 1:
...
def delete_from_dict(dic, word=1):
    if type(dic) != dict:
        print("You need to send a dictionary. You sent: <class 'str'>")
    elif word == 1:
        ...
        print(f"{word} is not on dict. Won't delete.")
